...
@pytest.mark.parametrize(
    ...
    argvalues=[
        ...
        ("evm_base_mainnet", "ETH", "native_transfer", None),
        ...
        ("evm_arbitrum_mainnet", "ETH", "native_transfer", None),
        ("evm_optimism_mainnet", "ETH", "native_transfer", None),
        ("evm_sonic_mainnet", "S", "native_transfer", None),
        ("evm_ethereum_sepolia", "ETH", "native_transfer", None),
